...
% Apply the new font to all headings (the 'disposition' elements)
\setkomafont{disposition}{\fontseries{eb}\selectfont\bfseries}


\newcommand{\bluebf}[1]{\textcolor{MidnightBlue}{\textbf{#1}}}

\usepackage[Bjornstrup]{fncychap}
\ChNumVar{\fontsize{84}{86}\usefont{OT1}{pzc}{m}{n}\selectfont}
\ChTitleVar{\raggedright\Huge\fontseries{eb}\selectfont\slshape}
